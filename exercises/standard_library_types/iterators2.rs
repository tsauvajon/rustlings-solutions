...
pub fn capitalize_each_word(words: &Vec<&str>) -> Vec<String> {
...
pub fn capitalize_into_string(words: &Vec<&str>) -> String {
    let mut capitalized_words: Vec<String> = Vec::new();
    for word in words.iter() {
        capitalized_words.push(capitalize_first(&word))
    }
...
mod tests {
    ...
    fn test_iterate_string_vec() {
        ...
        let capitalized_words: Vec<String> = capitalize_each_word(&words);
